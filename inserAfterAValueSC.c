...
struct Node* insertAfterAValue(struct Node * head, int value, int val){
...
int main(){
    ...
    // connecting the nodes
        ...
        struct Node *p = insertAfterAValue(head, 60, 50);
        printf("Linked LIst after inserting after a node of the linked list- \n");
